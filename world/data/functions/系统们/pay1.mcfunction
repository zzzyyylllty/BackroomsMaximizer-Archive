...
#人数检测
scoreboard players reset pay pay.rs
...
#检测选中uid是否存在游戏内
scoreboard players reset pay pay.cz
...
execute @a[score_pay.cz_min=0] ~ ~ ~ tellraw @s [{"text":"[pay] ","color":"gold","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false},{"text":"> > > | ","color":"aqua","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false},{"text":"【查找失败】此人未在线或没有注册","color":"gold","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false},{"text":" | < < <","color":"aqua","bold":true,"italic":false,"underlined":false,"strikethrough":false,"obfuscated":false}]
